...
if(isset($_POST['submit']))
{
    ...
    if(empty($errors)){
        ...
        $stmt = $conn->prepare("select * from trendyolveritabani.admin 
...
<body class="body-lo">
    ...
    <form class="form-lo" method="POST" action="adminLogin.php">
        <h3>Admin Login</h3>
        ...
        ?></h6>
        <div class="social">
          <div class="go"><i ></i><a style="color:white; text-decoration:none" href="login.php">kullanici girisi</a></div>
          <div class="fb" ><i></i><a style="color:coral; text-decoration:none" href="adminRegister.php">Admin Kayit Ol</a>  </div>
        </div>
    </form>
</body>
</body>

...
if(isset($_POST['submit']))
{
 $userName = $_POST['username'];
  ...
  if(empty($errors)){
    ...
    $stmt = $conn->prepare("insert into trendyolveritabani.admin (adminName, adminPassword) values(?,?)");
...
<div class="background">
    ...
    <form class="form-rg" action="adminRegister.php" method="POST">
        ...
        ?></h6>
        <div class="social">
          <div class="go"><i class=""></i><a style="color:white; text-decoration:none" href="register.php">kullanci register</a></div>
